...
class AlertHandler:
    ...
    def __init__(self, backend):
        ...
        # Đường dẫn audio đã được cập nhật sang assets/audio/ theo cấu trúc mới
        try:
            pygame.mixer.init()
            self.sounds = {
                "Drowsy":       pygame.mixer.Sound("assets/audio/drowsy.mp3"),
                "Yawning":      pygame.mixer.Sound("assets/audio/yawning.mp3"),
                "Distracted":   pygame.mixer.Sound("assets/audio/distracted.mp3"),
                "Calibration":  pygame.mixer.Sound("assets/audio/calibration.mp3")
            }
